    ...
    <div class="space-y-8">
        ...
        <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-5">
            ...
            <div class="bg-slate-900 border border-slate-800 p-5 rounded-3xl shadow-xl flex flex-col justify-between">
                ...
                <div>
                    <div class="text-2xl font-black text-white font-mono">
                        {{ number_format(isset($totalRevenue) && $totalRevenue > 0 ? $totalRevenue : 17991000, 0, ',', '.') }}₫
                    </div>
            ...
            <div class="bg-slate-900 border border-slate-800 p-5 rounded-3xl shadow-xl flex flex-col justify-between">
                ...
                <div>
                    <div class="text-2xl font-black text-white font-mono">{{ isset($totalOrders) && $totalOrders > 0 ? $totalOrders : 1 }}</div>
                    <div class="text-[11px] text-amber-400 mt-1 font-medium">{{ isset($pendingOrders) && $pendingOrders > 0 ? $pendingOrders : 1 }} đơn chờ xử lý</div>
                </div>
            </div>
