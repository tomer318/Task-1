    ...
    <div class="space-y-6">
        ...
        <div class="flex items-center justify-between">
            ...
            <a href="{{ route('orders.invoice', $order->id) }}" 
               target="_blank" 
               class="flex items-center gap-2 px-4 py-2 bg-slate-900 border border-rose-500/50 hover:bg-slate-800 text-rose-400 hover:text-white rounded-xl text-xs font-bold transition shadow-lg">
